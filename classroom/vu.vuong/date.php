...
function getSunLongitude($jdn, $timeZone) {
    ...
    $L = $L - 0.00569 - 0.00478 * $M.sin($omega * $dr);
	$L = $L*$dr;
...
<strong>Convert Solar to Lunar</strong>
<form action="" method="POST">
Day: <input name="dd" size=2 >
Month: <input name="mm" size=2 >
Year: <input name="yy" size=4 >
<input type="submit">
</form>
<?php
...
;
	...
	echo "Solar Day: $dd/$mm/$yy => ";
	$s = "Lunar day: $al[0]/$al[1]/$al[2]";
	if ($al[3] == 1) $s = $s . " Thang nhuan";
	echo "$s\n";
